          ...
          <div className="project-links">
            ...
            <div className="icons">
              <a
                rel="noopener noreferrer"
                target="_blank"
                href="https://github.com/fullstack831/react-brainsshare"
              >
          ...
          <div className="project-links">
            ...
            <div className="icons">
              <a
                rel="noopener noreferrer"
                target="_blank"
                href="https://github.com/fullstack831/NFT-staking-app"
              >
                <i className="fab fa-github" title="github repo" id="github">
                  {" "}
                </i>
          ...
          <div className="project-links">
            ...
            <div className="icons">
              <a
                rel="noopener noreferrer"
                target="_blank"
                href="https://github.com/fullstack831/uniclix_app"
              >
                <i className="fab fa-github" title="github repo" id="github">
                  {" "}
                </i>
          ...
          <div className="project-links">
            ...
            <div className="icons">
              <a
                rel="noopener noreferrer"
                target="_blank"
                href="https://github.com/fullstack831/pfron-frontend"
              >
                <i className="fab fa-github" title="github repo" id="github">
                  {" "}
                </i>
          ...
          <div className="project-links">
            ...
            <div className="icons">
              <a
                rel="noopener noreferrer"
                target="_blank"
                href="https://github.com/fullstack831/ibs-frontend"
              >
                <i
          ...
          <div className="project-links">
            ...
            <div className="icons">
              <a
                rel="noopener noreferrer"
                target="_blank"
                href="https://github.com/fullstack831/react-material-ui-camera"
              >
                <i
                  className="fab fa-github"
                  title="github repo"
