          ...
          <div className="project-links">
            ...
            <div className="icons">
              <a
                rel="noopener noreferrer"
                target="_blank"
                href="https://github.com/chaindev31/react-brainsshare"
              >
          ...
          <div className="project-links">
            ...
            <div className="icons">
              <a
                rel="noopener noreferrer"
                target="_blank"
                href="https://github.com/chaindev31/NFT-staking-app"
              >
                <i className="fab fa-github" title="github repo" id="github">
                  {" "}
                </i>
          ...
          <div className="project-links">
            ...
            <div className="icons">
              <a
                rel="noopener noreferrer"
                target="_blank"
                href="https://github.com/chaindev31/uniclix_app"
              >
                <i className="fab fa-github" title="github repo" id="github">
                  {" "}
                </i>
          ...
          <div className="project-links">
            ...
            <div className="icons">
              <a
                rel="noopener noreferrer"
                target="_blank"
                href="https://github.com/chaindev31/pfron-frontend"
              >
                <i className="fab fa-github" title="github repo" id="github">
                  {" "}
                </i>
          ...
          <div className="project-links">
            ...
            <div className="icons">
              <a
                rel="noopener noreferrer"
                target="_blank"
                href="https://github.com/chaindev31/ibs-frontend"
              >
                <i
          ...
          <div className="project-links">
            ...
            <div className="icons">
              <a
                rel="noopener noreferrer"
                target="_blank"
                href="https://github.com/chaindev31/react-material-ui-camera"
              >
                <i
                  className="fab fa-github"
                  title="github repo"
