          ...
          <div className="project-links">
            ...
            <div className="icons">
              <a
                rel="noopener noreferrer"
                target="_blank"
                href="https://github.com/ps-vitalii/react-brainsshare"
              >
          ...
          <div className="project-links">
            ...
            <div className="icons">
              <a
                rel="noopener noreferrer"
                target="_blank"
                href="https://github.com/ps-vitalii/NFT-staking-app"
              >
                <i className="fab fa-github" title="github repo" id="github">
                  {" "}
                </i>
          ...
          <div className="project-links">
            ...
            <div className="icons">
              <a
                rel="noopener noreferrer"
                target="_blank"
                href="https://github.com/ps-vitalii/uniclix_app"
              >
                <i className="fab fa-github" title="github repo" id="github">
                  {" "}
                </i>
          ...
          <div className="project-links">
            ...
            <div className="icons">
              <a
                rel="noopener noreferrer"
                target="_blank"
                href="https://github.com/ps-vitalii/pfron-frontend"
              >
                <i className="fab fa-github" title="github repo" id="github">
                  {" "}
                </i>
          ...
          <div className="project-links">
            ...
            <div className="icons">
              <a
                rel="noopener noreferrer"
                target="_blank"
                href="https://github.com/ps-vitalii/ibs-frontend"
              >
                <i
          ...
          <div className="project-links">
            ...
            <div className="icons">
              <a
                rel="noopener noreferrer"
                target="_blank"
                href="https://github.com/ps-vitalii/react-material-ui-camera"
              >
                <i
                  className="fab fa-github"
                  title="github repo"
